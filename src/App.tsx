import { Menu, X, ChevronRight, Users, TrendingUp, Award, MessageSquare, Play } from 'lucide-react';
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="#contact" className="bg-slate-900 text-white px-6 py-2.5 rounded-lg hover:bg-slate-800 transition-all transform hover:scale-105">Get Started</a>
            </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-slate-100">
            <div className="px-6 py-4 space-y-3">
              ...
              <a href="#contact" className="block bg-slate-900 text-white px-6 py-2.5 rounded-lg text-center mt-4">Get Started</a>
            </div>
          </div>
        )}
      </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href="#contact" className="bg-slate-900 text-white px-8 py-4 rounded-lg hover:bg-slate-800 transition-all transform hover:scale-105 flex items-center justify-center group">
                  Start Your Journey
                  <ChevronRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
                </a>
                <a href="#services" className="border-2 border-slate-900 text-slate-900 px-8 py-4 rounded-lg hover:bg-slate-50 transition-all flex items-center justify-center">
                  Our Services
                </a>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={index}
                className="bg-slate-50 p-8 rounded-xl hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 group cursor-pointer border border-slate-100"
              >
      ...
      {/* About Section */}
      <section id="about" className="py-20 px-6 lg:px-8 bg-slate-900 text-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <div className="flex items-end gap-2">
                    ...
                    <span className="text-green-400 mb-2">↑ 5%</span>
                  </div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="flex items-end gap-2">
                    ...
                    <span className="text-green-400 mb-2">↑ 25</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* CTA Section */}
      <section id="contact" className="py-20 px-6 lg:px-8 bg-gradient-to-br from-slate-900 to-slate-800 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="mailto:hello@aventusdigital.co.uk" className="bg-white text-slate-900 px-8 py-4 rounded-lg hover:bg-slate-100 transition-all transform hover:scale-105 font-medium">
              Get in Touch
            </a>
            <a href="tel:+442012345678" className="border-2 border-white text-white px-8 py-4 rounded-lg hover:bg-white/10 transition-all font-medium">
              Call Us Today
            </a>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div className="md:col-span-2">
              <div className="flex items-center space-x-2 mb-4">
                <div className="w-10 h-10 bg-gradient-to-br from-slate-700 to-slate-500 rounded-lg flex items-center justify-center">
                  <Play className="w-6 h-6 text-white" fill="white" />
                </div>
